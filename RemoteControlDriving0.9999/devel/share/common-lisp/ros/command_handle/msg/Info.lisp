...
(cl:defmethod cl:initialize-instance :after ((m <Info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name command_handle-msg:<Info> is deprecated: use command_handle-msg:Info instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader command_handle-msg:header-val is deprecated.  Use command_handle-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader command_handle-msg:mode-val is deprecated.  Use command_handle-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader command_handle-msg:speed-val is deprecated.  Use command_handle-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'gear-val :lambda-list '(m))
(cl:defmethod gear-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader command_handle-msg:gear-val is deprecated.  Use command_handle-msg:gear instead.")
  (gear m))

(cl:ensure-generic-function 'lb-val :lambda-list '(m))
(cl:defmethod lb-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader command_handle-msg:lb-val is deprecated.  Use command_handle-msg:lb instead.")
  (lb m))

(cl:ensure-generic-function 'hb-val :lambda-list '(m))
(cl:defmethod hb-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader command_handle-msg:hb-val is deprecated.  Use command_handle-msg:hb instead.")
  (hb m))

(cl:ensure-generic-function 'hnk-val :lambda-list '(m))
(cl:defmethod hnk-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader command_handle-msg:hnk-val is deprecated.  Use command_handle-msg:hnk instead.")
  (hnk m))

(cl:ensure-generic-function 'rotate-val :lambda-list '(m))
(cl:defmethod rotate-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader command_handle-msg:rotate-val is deprecated.  Use command_handle-msg:rotate instead.")
  (rotate m))

(cl:ensure-generic-function 'rearview-val :lambda-list '(m))
(cl:defmethod rearview-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader command_handle-msg:rearview-val is deprecated.  Use command_handle-msg:rearview instead.")
  (rearview m))

(cl:ensure-generic-function 'acc_p-val :lambda-list '(m))
(cl:defmethod acc_p-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader command_handle-msg:acc_p-val is deprecated.  Use command_handle-msg:acc_p instead.")
  (acc_p m))

(cl:ensure-generic-function 'clu_p-val :lambda-list '(m))
(cl:defmethod clu_p-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader command_handle-msg:clu_p-val is deprecated.  Use command_handle-msg:clu_p instead.")
  (clu_p m))

(cl:ensure-generic-function 'brk_p-val :lambda-list '(m))
(cl:defmethod brk_p-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader command_handle-msg:brk_p-val is deprecated.  Use command_handle-msg:brk_p instead.")
  (brk_p m))
