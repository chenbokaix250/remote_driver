...
(cl:defmethod cl:initialize-instance :after ((m <Info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sys_test-msg:<Info> is deprecated: use sys_test-msg:Info instead.")))
...
(cl:defmethod gear-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sys_test-msg:gear-val is deprecated.  Use sys_test-msg:gear instead.")
  (gear m))

(cl:ensure-generic-function 'lb-val :lambda-list '(m))
(cl:defmethod lb-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sys_test-msg:lb-val is deprecated.  Use sys_test-msg:lb instead.")
  (lb m))

(cl:ensure-generic-function 'hb-val :lambda-list '(m))
(cl:defmethod hb-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sys_test-msg:hb-val is deprecated.  Use sys_test-msg:hb instead.")
  (hb m))

(cl:ensure-generic-function 'hnk-val :lambda-list '(m))
(cl:defmethod hnk-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sys_test-msg:hnk-val is deprecated.  Use sys_test-msg:hnk instead.")
  (hnk m))

(cl:ensure-generic-function 'rotate-val :lambda-list '(m))
(cl:defmethod rotate-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sys_test-msg:rotate-val is deprecated.  Use sys_test-msg:rotate instead.")
  (rotate m))

(cl:ensure-generic-function 'rearview-val :lambda-list '(m))
(cl:defmethod rearview-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sys_test-msg:rearview-val is deprecated.  Use sys_test-msg:rearview instead.")
  (rearview m))

(cl:ensure-generic-function 'acc_p-val :lambda-list '(m))
(cl:defmethod acc_p-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sys_test-msg:acc_p-val is deprecated.  Use sys_test-msg:acc_p instead.")
  (acc_p m))

(cl:ensure-generic-function 'clu_p-val :lambda-list '(m))
(cl:defmethod clu_p-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sys_test-msg:clu_p-val is deprecated.  Use sys_test-msg:clu_p instead.")
  (clu_p m))

(cl:ensure-generic-function 'brk_p-val :lambda-list '(m))
(cl:defmethod brk_p-val ((m <Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sys_test-msg:brk_p-val is deprecated.  Use sys_test-msg:brk_p instead.")
  (brk_p m))
